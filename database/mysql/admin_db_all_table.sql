...
INSERT INTO `menus` (`id`, `permissions_uuid`, `title`, `title_lang`, `status`, `pid`, `pids`, `component`, `path`, `type`, `icon`, `sort`, `is_shortcut`, `describe`, `created_at`, `updated_at`) VALUES (6, '100036', '参数配置', 'routes.admin.system.config', 1, 1, '1', '/admin/system/config/index', 'config', 1, 'ant-design:profile-outlined', 6, 0, '参数配置', '2022-07-04 12:33:17', '2022-07-13 11:15:30');
...
INSERT INTO `permissions` (`id`, `uuid`, `title`, `module`, `pid`, `pids`, `type`, `describe`, `created_at`, `updated_at`) VALUES (36, '100036', '参数配置', 'config.index', 1, '1', 5, '参数配置(菜单,页面)', '2022-07-04 11:47:39', '2022-07-04 11:47:39');
INSERT INTO `permissions` (`id`, `uuid`, `title`, `module`, `pid`, `pids`, `type`, `describe`, `created_at`, `updated_at`) VALUES (37, '100037', '添加', '8', 36, '1,36', 7, '添加参数配置(按钮,页面)', '2022-07-04 11:58:57', '2022-07-04 11:58:57');
INSERT INTO `permissions` (`id`, `uuid`, `title`, `module`, `pid`, `pids`, `type`, `describe`, `created_at`, `updated_at`) VALUES (38, '100038', '保存', 'config.add', 37, '1,36,37', 1, '添加参数配置(新增)', '2022-07-04 12:00:23', '2022-07-04 12:00:23');
INSERT INTO `permissions` (`id`, `uuid`, `title`, `module`, `pid`, `pids`, `type`, `describe`, `created_at`, `updated_at`) VALUES (39, '100039', '编辑', '8', 36, '1,36', 7, '编辑参数配置(按钮,页面)', '2022-07-04 12:02:02', '2022-07-04 12:02:02');
INSERT INTO `permissions` (`id`, `uuid`, `title`, `module`, `pid`, `pids`, `type`, `describe`, `created_at`, `updated_at`) VALUES (40, '100040', '保存', 'config.edit', 39, '1,36,39', 2, '编辑参数配置(修改)', '2022-07-04 12:04:30', '2022-07-04 12:04:30');
INSERT INTO `permissions` (`id`, `uuid`, `title`, `module`, `pid`, `pids`, `type`, `describe`, `created_at`, `updated_at`) VALUES (41, '100041', '查看配置缓存', 'config.getCache', 36, '1,36', 7, '查看配置缓存(按钮, 查看)', '2022-07-04 21:24:37', '2022-07-04 21:24:37');
INSERT INTO `permissions` (`id`, `uuid`, `title`, `module`, `pid`, `pids`, `type`, `describe`, `created_at`, `updated_at`) VALUES (42, '100042', '刷新缓存', 'config.renew', 36, '1,36', 7, '刷新配置缓存(按钮)', '2023-06-24 13:25:38', '2023-06-26 04:02:04');
...
INSERT INTO `permissions` (`id`, `uuid`, `title`, `module`, `pid`, `pids`, `type`, `describe`, `created_at`, `updated_at`) VALUES (44, '100044', '查看缓存值', 'cache.getValue', 43, '1,43', 7, '查看缓存值(按钮, 查看)', '2022-07-06 16:24:52', '2023-06-26 04:01:54');
...
INSERT INTO `permissions` (`id`, `uuid`, `title`, `module`, `pid`, `pids`, `type`, `describe`, `created_at`, `updated_at`) VALUES (47, '100047', '服务器信息', 'cache.info', 43, '1,43', 7, '服务器信息(按钮, 查看)', '2022-07-06 16:26:57', '2023-06-26 04:01:38');
...
INSERT INTO `permissions` (`id`, `uuid`, `title`, `module`, `pid`, `pids`, `type`, `describe`, `created_at`, `updated_at`) VALUES (50, '100050', '查看缓存值', 'cache.searchKeyValue', 48, '1,43,48', 7, '查看缓存值(按钮, 查看)', '2023-06-26 12:56:24', '2023-06-26 04:56:51');
...
CREATE TABLE `users` (
  ...
  `secure_key` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT '' COMMENT '安全秘钥：如google验证器秘钥',
